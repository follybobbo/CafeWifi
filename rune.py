...
#
# from app.forms.search_venue_form import SearchVenue
# from app.forms.search_venue_form import VenueInfo
# from app.forms.search_venue_form import RegisterForm
# from app.forms.search_venue_form import LoginForm, DashboardForm
# from app.Utils.reviewquestions import survey_data
#
# import secrets
# import os
#
# import requests
# from app.decorators.ratelimit import login_token_bucket_limiter
# from app.decorators.email_verification import email_verification_required
#
# from flask_limiter import Limiter
# from flask_limiter.util import get_remote_address
#
# # import unprotected, protected, create_flask_app
# from app import unprotected, protected, create_flask_app
# from app.Utils.format_route_params import slugify, de_slugify
#
# from app.services.token_and_deserializer_service import make_token, de_serializer, general_services, data_services, review_services
#
# from app.services import user_services
# from app.services import cafe_services, email_service
...
#     user = user_services.get_user(int(user_id))
...
#     result = cafe_services.get_all_cafes_and_order_by_id()
#     cafes = result.all()
#
#     location_list = []
#     # for rows in cafes:
...
#
#     location_list = general_services.get_cafe_city_list(cafes, location_list)
#
...
#         # )
#
#         cafe_services.write_new_cafe(session.get("location_name"), session.get("picture_url"), session.get("city"),
...
#         # db.session.commit()
#
#         cafe_instance = cafe_services.query_db_and_filter_by(filter_value=session.get("location_name"))
#
...
#         review_services.write_record_to_review_db("", "", "", "", "",
#                                                   "", "", "", "",
#                                                   "", "", "", "",
#                                                   "", "", "", "",
#                                                   "", "", "", "",
...
#     cafe = cafe_services.get_all_cafe_instance_by_location(location)
...
#     cafe_db = cafe_services.get_single_cafe_by_cafe_name(de_sluged_cafe_name)
...
#     review_db = review_services.get_review_record_using_id(cafe_id)
...
#     #     cafe_instance = cafe_services.get_single_cafe_by_cafe_name(normal_cafe_name)
...
#         # cafe_instance = cafe_services
#         cafe_instance = cafe_services.query_db_and_filter_by(filter_value=de_sluged_cafe_name)
#         # cafe_instance = Cafe.query.filter_by(
#         #     name=de_sluged_cafe_name
#         # ).first()
#         cafe_id = cafe_instance.id
#         review_instance = review_services.get_review_record_using_id(cafe_id)
#
#
...
#         result = review_services.update_review_record(review_instance, wifi, power_sockets, length_of_work,
#                                                       tables_and_chairs, is_it_quiet, audio_and_video, other_people_working,
...
#                                                       restroom, wheelchair_accessible, air_conditioned, smoke_free, pet_friendly,
...
#                                cafe=de_sluged_cafe_name, summary=summary_rating, survey_data=survey_data, review_data=prepopulated_data_dict)
#     else:
#         csrf_token = secrets.token_hex(16)
#         session["csrf_token"] = csrf_token
#         data_dict = {}
...
#     # }
#     cafe_instance_ordered_by_country = cafe_services.get_all_cafe_and_order_by_country()
#     # data = db.session.execute(db.select(Cafe).order_by(Cafe.country)).scalars()
#     storage = general_services.create_country_city_list_dictionary(cafe_instance_ordered_by_country, storage)
#    #use google api to get current country, and make current country first on the list of countries/
#     # for rows in cafe_instance_ordered_by_country:
#     #     #assigns country to var
#     #     country = rows.country
#     #
#     #     #gets list of country in city_dict
#     #     country_list = storage.keys()
#     #
#     #     #if currently looped country is present in country_list
#     #     if country in country_list:
#     #         #gets its city list
#     #         city_list = storage.get(country)
...
#     cafe_info = cafe_services.get_single_cafe_by_cafe_name(name)
...
#     review_info = review_services.get_review_record_using_id(cafe_id)
...
#     data_dict = data_services.get_data_dict_for_show_location(review_instance=review_info)
#     # data_dict = {
#     #
#     #     "PRODUCTIVITY": {
...
#     user_data = user_services.create_user_data_for_dashboard(user)
#     # user_data = {
...
#         user_exist = user_services.get_user_by_email(email)
...
#
#             user = user_services.create_new_user(email, name, surname, city, hashed_password)
#             # user = User(
#             #     email=email,
#             #     name=name,
#             #     surname=surname,
...
#             # print(verify_url)
#             email_service.send_mail(verify_url, email)
#
...
#
# """                                            FUNCTIONS                                                    """
# # def check_if_user_can_resend_verification_email(user_id):
...
#     can_send_the_mail = email_service.check_if_user_can_resend_verification_email(current_user.id, redis_client)
#
...
#         token = make_token(email)
#         verify_url = url_for("unprotected.verify_email", token=token, _external=True)
#         response = email_service.send_mail(verify_url, email)
#         # print(response.data)
#
#         if response.data:
...
#     restaurant_to_update = cafe_services.get_single_cafe_by_cafe_name(restaurant_name)
...
#     result = general_services.update_status_of_cafe_to_opened_closed(restaurant_to_update, status)
#     return result
#     # if status:
...
#     db_restaurant = cafe_services.get_single_cafe_by_cafe_name(restaurant_name)
...
#
#     #GET DB TO UPDATE
#     restaurant_to_update = cafe_services.get_single_cafe_by_cafe_name(name_of_restaurant)
...
#
#     #GET REVIEW DATABASE
#     review_db = review_services.get_review_record_using_id(restaurant_id)
...
#     list_of_places = []
#     with app.app_context():
#         cafe_instance = cafe_services.get_all_cafes_and_order_by_id()
...
#     lat_long_list = []
#     city = request.args.get("city")
#     cafe_instance = cafe_services.get_all_cafe_instance_by_location(city)
